"""
Ejercicio: Red neuronal para predecir XOR
Usando michigrad, implementar una red con dos neuronas lineales.
"""
...
dot_graph_1.render('grafo_01_after_forward', cleanup=True)

model.zero_grad()
loss_first.backward()

dot_graph_2 = show_graph(loss_first, format='svg', rankdir='TB')
dot_graph_2.render('grafo_02_after_backward', cleanup=True)
...
try:
    ...
    print("\nGráfico guardado como 'training_loss_curve.png'")
    
except ImportError:
    print("\nmatplotlib no instalado")

print("\nArchivos generados:")
print("  - grafo_01_after_forward.svg")
print("  - grafo_02_after_backward.svg")
